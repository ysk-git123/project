    ...
    return (
        <div className="shoppdetail">
            ...
            <div className="headers">
                <div className="header-btn">返回</div>
            ...
            <div className="product-image-container">
                <img src="./2.jpeg" alt="商品图片" className='headerimg' />
            </div>

            {/* 价格和信息 */}
            <div className='detailone'>
                <p className='headerp'>¥239</p>
                <p>价格 <span className='headerspan'>¥799</span></p>
                <p>女童经典长款中厚羽绒服-宝石紫</p>
            </div>
            ...
            <div className="card">
                <div className='detailtwo'>
                    ...
                    <p className="detailtwop"><span>商品系列:</span><span>城市户外</span></p>
                </div>
            </div>
